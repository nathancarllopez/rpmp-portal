...
function addMeals(report: PDFDocumentWithTables, meals: Meal[]) {
  ...
  report.table({
    headers: [
      ...
      { label: "Weight (oz)", property: "weightOz", width: 100, align: "right" },
      { label: "Weight (lb-oz)", property: "weightLbOz", width: 100, align: "right" },
      { label: "Cooked Weight (lb-oz)", property: "cookedWeightOz", width: 100, align: "right" },
      { label: "Backstock (oz)", property: "backstockWeight", width: 100, align: "right" }
    ],
