...
import { useDeleteUserMutation } from "@/integrations/tanstack-query/mutations/deleteUser";
...
export default function ViewEditProfile({
  ...
  const profileInfo = [
    ...
    { header: "Role", data: capitalize(profileToDisplay.role || "employee") },
    {
      header: "Kitchen Rate",
...
// import { Link } from "@tanstack/react-router";
// import { notifications } from "@mantine/notifications";
// // import { useAuth } from "@/integrations/supabase/auth/AuthProviderOld";
// import deleteUser from "@/api/deleteUser";
// import { useQueryClient } from "@tanstack/react-query";
// import capitalize from "../../../util/capitalize";
// import ProfilePic from "./ProfilePic";
