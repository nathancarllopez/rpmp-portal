/**
 * Use this for the option when the user doesn't care about validating the order data
 */


// import { Box, Button, Container, Group, Stack, Stepper, Title } from "@mantine/core";
...
//     const pdfBlob = await uploadOrderFile(files[0]);
