...
import { Database as GenDatabase, Json } from "./database.types";
export type Database = MergeDeep<GenDatabase, {
    public: {
        Views: {
            all_backstock: {
                Row: {
...
export type CamelCase<S extends string> = S extends `${infer P}_${infer R}` ? `${P}${Capitalize<CamelCase<R>>}` : S;
...
export declare const containerSizes: readonly ["2.5oz", "4oz", "6oz", "8oz", "10oz", "bulk"];
